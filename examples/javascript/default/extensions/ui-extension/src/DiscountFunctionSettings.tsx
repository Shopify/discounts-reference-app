...
async function getMetafieldDefinition(adminApiQuery: AdminApiQuery) {
  const query = `#graphql
...
async function createMetafieldDefinition(adminApiQuery: AdminApiQuery) {
  const definition = {
    access: {
...
function parsePercentageMetafield(
