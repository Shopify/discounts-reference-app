...
import deliveryRouter from "./src/delivery";
...
app.get("/", function (req: Request, res: Response) {
  res
    .status(200)
    .send(
      "The server is running at http://localhost:3000, reach it by posting to /cart or /delivery. See the README for more information.",
    );
});
