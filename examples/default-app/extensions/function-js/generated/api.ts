...
export type CartOperation =
  ...
  { addOrderDiscounts: OrderDiscounts; addProductDiscounts?: never; addValidDiscountCodes?: never; }
  |  /** A group of product discounts that share a selection strategy. */
  { addOrderDiscounts?: never; addProductDiscounts: ProductDiscounts; addValidDiscountCodes?: never; }
  |  /**
   ...
   */
  { addOrderDiscounts?: never; addProductDiscounts?: never; addValidDiscountCodes: ValidDiscountCodes; };
...
export type DeliveryOperation =
  /** A group of delivery discounts that share a selection strategy. */
  { addDeliveryDiscounts: DeliveryDiscounts; addValidDiscountCodes?: never; }
  |  /**
   * A list of valid discount codes that correspond to external discounts. This can
   * only be used by Functions with network access.
   */
