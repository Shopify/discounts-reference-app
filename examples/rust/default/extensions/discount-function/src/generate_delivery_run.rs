...
use cart_delivery_options_discounts_generate_run::output::{
    ...
    DeliveryDiscountSelectionStrategy, DeliveryDiscountsAddOperation, DeliveryGroupTarget, DeliveryOperation,
    CartDeliveryOptionsDiscountsGenerateRunResult, Percentage,
};
...
fn generate_delivery_run(input: ResponseData) -> Result<CartDeliveryOptionsDiscountsGenerateRunResult> {
    ...
    Ok(CartDeliveryOptionsDiscountsGenerateRunResult {
        operations: vec![DeliveryOperation::DeliveryDiscountsAdd(DeliveryDiscountsAddOperation {
